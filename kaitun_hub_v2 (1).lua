...
-- Loop 1: Auto Farm Level — ưu tiên: Saber(300) > Sea2(700) > AutoMelee > Fruit > Farm(+mastery)
task.spawn(function()
    while task.wait(0.1) do
        ...
        --   false     → không có gì cần làm với melee
            ...
            -- Ưu tiên 4: Collect fruit (kể cả khi đang farm mastery)
            ...
            -- Ưu tiên 5: Farm bình thường (bao gồm cả mastery farming)
            else
